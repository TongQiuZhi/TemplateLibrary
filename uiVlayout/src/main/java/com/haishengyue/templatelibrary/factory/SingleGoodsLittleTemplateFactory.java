...
public class SingleGoodsLittleTemplateFactory implements ITemplateFactory {
    @Override
    public SubViewHolder getViewHolder(Context context) {
        return new SingleGoodsHolder(LayoutInflater.from(context).inflate(R.layout.lish_item_little_goods_layout, null));
    }
}
